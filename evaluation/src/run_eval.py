...
def lenrag(args):
    config_dict = {
        ...
        "prompt_template_type": args.prompt_template_type,
    ...
    from flashrag.pipeline import ItSearchPipeline
    pipeline = ItSearchPipeline(config)
    result = pipeline.run(test_data)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--prompt_template_type", type=str,  required=True)
    parser.add_argument("--result_output_file", type=str, required=True)
